...
public class Subscribe {
	...
	public String toString() {
		if (id == 0)
			return "userID#" + userID + ", magazineID#" + magazineID + ", Subscription completed: " + subscribeStatus
					+ ", Date of subscription: " + subscribeDate + ", Subscription period: " + subscribePeriod
					+ " month";
		else
			return "Subscribe ID#" + id + ": userID#" + userID + ", magazineID#" + magazineID
					+ ", Subscription completed: " + subscribeStatus + ", Date of subscription: " + subscribeDate
					+ ", Subscription period: " + subscribePeriod + " month";
	}
