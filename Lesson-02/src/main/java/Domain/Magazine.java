...
public class Magazine {
	...
	public String toString() {
		if (id == 0)
			return "Magazine \"" + title + "\", " + description + ", Date of realise: " + publishDate + ", Price: "
					+ subscribePrice / 100 + "." + String.format("%02d", subscribePrice % 100) + " грн.";
		else
			return "Magazine ID#" + id + ": Magazin \"" + title + "\", " + description + ", Date of realise: " + publishDate
					+ ", Price: " + subscribePrice / 100 + "." + String.format("%02d", subscribePrice % 100)
					+ " grn.";
	}
